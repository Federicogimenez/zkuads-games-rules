...
import logo from '/domino/logo.png';
import basic_rules from '/domino/basic_rules.gif';
import request from '/domino/request_tile.gif';
import bonus_point from '/domino/bonus.gif';
import streak from '/domino/streak.gif';
import booster_1 from '/domino/booster_1.png';
import booster_2 from '/domino/booster_2.png';
import booster_3 from '/domino/booster_3.png';
    ...
    <main className="w-full h-full text-white text-center overflow-x-hidden mx-auto">
      <section className="bg-gradient-to-b from-black to-70% to-gray-secondary pt-10">
        ...
        <p className="description-1">
          {t.domino.about_text_2}
        </p>

        <hr />

        <h5 className="heading-2">
          {t.domino.about_text_3}
        </h5>
        ...
        <h2 className="heading-1 mb-0">{t.base.game_scoring}</h2>
          <h5 className="heading-2">
            ...
            <img 
                ...
                className="gif-box-1"  
            />
            <p className="description-1 mt-4">{t.domino.scoring_text_2}</p>
      </section>
      ...
      <section className="bg-gray-secondary">
        ...
        <div className="flex justify-center items-start flex-wrap gap-5 p-2 mb-10">
          <div className="grow max-w-[250px]">
            <h5 className="heading-3">{t.domino.boosters_booster_1_title}</h5>
            <img src={booster_1} alt={"extra time"} className="w-[160px] landscape:lg:w-[200px] h-auto mx-auto object-contain mb-4"  />
            <p className="description-1">{t.domino.boosters_booster_1_p}</p>
          </div>
          
          <div className="grow max-w-[250px]">
            <h5 className="heading-3">{t.domino.boosters_booster_2_title}</h5>
            <img src={booster_2} alt={"extra time"} className="w-[160px] landscape:lg:w-[200px] h-auto mx-auto object-contain mb-4"  />
            <p className="description-1">{t.domino.boosters_booster_2_p}</p>
          </div>
          
          <div className="grow max-w-[250px]">
            <h5 className="heading-3">{t.domino.boosters_booster_3_title}</h5>
            <img src={booster_3} alt={"extra time"} className="w-[160px] landscape:lg:w-[200px] h-auto mx-auto object-contain mb-4"  />
            <p className="description-1">{t.domino.boosters_booster_3_p}</p>
          </div>
        </div>
      ...
      <section className="bg-gray-primary py-8">
        ...
        <p className="description-1">
          {t.domino.game_end_text_1}
        </p>
        <p className="description-1">
          {t.domino.game_end_text_2}
        </p>
      </section>
    </main>
  )
